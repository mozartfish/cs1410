...
public class SearchingLoops
{
    ...
    /**
     * Returns an integer token from numbers that has at least n factors.  Returns 0 if there is
     * no such token.  The string numbers is required to contain only positive integer tokens.
     * 
