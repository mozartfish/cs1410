...
/**
 * Top-level window for a simple paint application. Notice how this class extends JFrame (which makes it a top-level
 * window) and implements ActionListener (which allows is to register to receive action events).
 */
